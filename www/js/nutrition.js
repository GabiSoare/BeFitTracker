...
function populateDB(tx) {
    ...
    tx.executeSql('INSERT INTO FOOD (desc, energ_kcal, protein, lipid, carbo) VALUES ("'+food_name.value+'",'+parseFloat(energy.value)+',"'+protein.value+'","'+lipid.value+'","'+carbo.value+'")');
}
